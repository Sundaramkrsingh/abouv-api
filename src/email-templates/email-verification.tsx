        ...
        <Container style={styles.container}>
          <Section style={styles.whiteBox}>
            ...
            >
              <Img
                width="123.55px"
                height="39.14px"
                src={`https://${env}abouv.com/email-template/abouv-email.png`}
                alt="abouv"
              />
            </Section>
            <Section style={styles.sectionCenter}>
              <Text style={styles.textLarge}>Hey there</Text>
              <Text style={styles.textNormal}>
                {type === 'signup'
                  ? 'Code for profile creation'
                  : 'Code for email login'}
              </Text>
              <Text style={styles.codeText}>Code is {otp}</Text>
          ...
          <Section style={styles.footer}>
            <Img
              width="85.15px"
              height="87.6px"
              src={`https://${env}abouv.com/email-template/abouv-logo-email.png`}
              alt="abouv"
            ...
            <Section style={{ display: 'flex', marginLeft: '30px' }}>
              <a href={instaUrl}>
                <Img
                  src={`https://${env}abouv.com/email-template/instagram.png`}
                  alt="instagram"
                  width="36px"
                  height="36px"
              ...
              <a href={linkedinUrl}>
                <Img
                  src={`https://${env}abouv.com/email-template/linkedin.png`}
                  alt="Linkedin"
                  width="35.88px"
                  height="35.39px"
